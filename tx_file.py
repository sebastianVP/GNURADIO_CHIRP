...
from gnuradio.mod_chirp_2  import chirp_usrp
import numpy as np
...
class tx_file(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "tx_file")
        ...
        self.chirp_file = chirp_file = '/home/soporte/Downloads/script/' + chirp_param + '.bin'
    ...
    def set_chirp_param(self, chirp_param):
        ...
        self.set_chirp_file('/home/soporte/Downloads/script/' + self.chirp_param + '.bin')
