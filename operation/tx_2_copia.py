...
from mod_chirp_2 import chirpStandard, chirpCentral, chirp_mod, chirp_usrp
import math
import os
import re
import sys
...
#python3 tx_2_copia.py -m 192.168.20.7 -d "A:AB" -y "TX/RX" -f 70132500 -r 20000000 -file_chirp /home/soporte/Descargas/file_create/test/fc=0/test_10M/chirp_amp_1_ipp_0.0004_dc_15_sr_10000000_fc_0_bw_2000000.bin

#Example FInal 2 XD: Generación de señal a partir de archivo .json (UTILZAR)
#python3 tx_2_copia.py -m 192.168.20.7 -d "A:AB" -y "TX/RX" -f 70132500 -r 20000000 -file_chirp chirp_ipp_0.0004_dc_15.0_sr_20000000.0_fc_0.0_bw_4000000.0_amp_1.0.json

#Example Final 3 :D No terminado :(
#Generación con Sample Rate de RX
#python3 tx_2_copia.py -m 192.168.20.7 -d "A:AB" -y "TX/RX" -f 0 -r 20000000 -file_chirp chirp_ipp_0.0004_dc_15.0_sr_tx_20000000.0_sr_rx_2500000.0_fc_1000000.0_bw_1000000.0_amp_1.0.json
